                                                    ...
                                                    <li class="woocommerce-order-overview__total total">
                                                        Total: <strong><span
                                                                class="woocommerce-Price-amount amount"><bdi><span
                                                                        class="woocommerce-Price-currencySymbol">&#2547;&nbsp;</span>{{$order->qty*$order->p_price + $order->shipping_price}}</bdi></span></strong>
                                                    </li>
                                                        ...
                                                        <tbody>
                                                            <tr class="woocommerce-table__line-item order_item">
                                                                ...
                                                                <td
                                                                    class="woocommerce-table__product-name product-name">
                                                                    মরিয়ম ফুল <strong
                                                                        class="product-quantity">&times;&nbsp;{{$order->qty}}</strong>
                                                                </td>

                                                                <td
                                                                    class="woocommerce-table__product-total product-total">
                                                                    <span class="woocommerce-Price-amount amount"><bdi><span
                                                                                class="woocommerce-Price-currencySymbol">&#2547;&nbsp;</span>{{$order->qty*$order->p_price}}</bdi></span>
                                                                </td>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <td><span class="woocommerce-Price-amount amount"><span
                                                                            class="woocommerce-Price-currencySymbol">&#2547;&nbsp;</span>{{$order->qty*$order->p_price}}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">Shipping:</th>
                                                                <td><span class="woocommerce-Price-amount amount"><span
                                                                            class="woocommerce-Price-currencySymbol">&#2547;&nbsp;</span>{{$order->shipping_price}}</span>&nbsp;<small
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><span class="woocommerce-Price-amount amount"><span
                                                                            class="woocommerce-Price-currencySymbol">&#2547;&nbsp;</span>{{$order->qty*$order->p_price + $order->shipping_price}}</span>
                                                                </td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
